...
namespace MiniUI
{
    public static class SampleOverlay
    {
        public static Overlay New(IServiceRegistry services)
        {
            ...
            var label = new Label { Position = new Vector2(8, 8), Text = "I'm a label.", Width = 200, Height = 48 };
            var button = new Button { Position = new Vector2(16, 64), Content = new Label { Text = "Button", TextStyleClass = "SmallCenter" } };
