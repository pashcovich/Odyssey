...
using Odyssey.Interaction.Interop;

namespace Odyssey.Interaction.Multitouch.WindowsForms
{
    /// <summary>
    ...
    public class Factory
    {
        ...
        public static T CreateHandler<T>(Control control) where T : Handler
        {
            return Handler.CreateHandler<T>(new ControlWrapper(control));
        }
