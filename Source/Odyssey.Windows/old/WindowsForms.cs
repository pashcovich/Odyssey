...
using PointerDeviceType = Odyssey.Devices.PointerDeviceType;
using PointerPoint = Odyssey.Devices.PointerPoint;
...
namespace Odyssey.UserInterface
{
    public static class WindowsForms
    {
        ...
        private static PointerEventArgs ConvertMouseEvent(MouseEventArgs e)
        {
            ...
            PointerPoint odysseyPointerPoint = new PointerPoint(0, odysseyPointerProperties, odysseyPointerDevice)
            {
