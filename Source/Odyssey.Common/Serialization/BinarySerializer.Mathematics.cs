...
namespace Odyssey.Serialization
{
    public partial class BinarySerializer
    {
        ...
        private static void SerializeColor(ref Color value, BinarySerializer serializer)
        {
        ...
        private static void SerializeColor4(ref Color4 value, BinarySerializer serializer)
        {
            serializer.Serialize(ref value);
        }

        private static void SerializeVector2(ref Vector2 value, BinarySerializer serializer)
        {
            serializer.Serialize(ref value);
        }

        private static void SerializeVector3(ref Vector3 value, BinarySerializer serializer)
        {
            serializer.Serialize(ref value);
        }
