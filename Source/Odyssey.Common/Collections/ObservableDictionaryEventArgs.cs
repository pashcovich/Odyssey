...
{
    /// <summary>
    ///     Event arguments for the <see cref="ObservableDictionary{TKey,TValue}.ItemAdded" /> and
    ///     <see cref="ObservableDictionary{TKey,TValue}.ItemRemoved" /> events.
    /// </summary>
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ObservableDictionaryEventArgs{TKey,TValue}" /> class from the provided
