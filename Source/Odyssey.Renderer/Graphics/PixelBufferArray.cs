namespace Odyssey.Graphics
{
    ...
    public sealed class PixelBufferArray
    {
        ...
        public PixelBuffer this[int bufferIndex]
        {
            get
            {
                return image.pixelBuffers[bufferIndex];
            }
        }
        ...
        public int Count { get { return image.pixelBuffers.Length; } }
        ...
        public PixelBuffer this[int arrayOrDepthSlice, int mipIndex]
        {
            get
            {
                return image.GetPixelBuffer(arrayOrDepthSlice, mipIndex);
            }
        }
        ...
        public PixelBuffer this[int arrayIndex, int zIndex, int mipIndex]
        {
            get
            {
                return image.GetPixelBuffer(arrayIndex, zIndex, mipIndex);
            }
        }
    }
}
