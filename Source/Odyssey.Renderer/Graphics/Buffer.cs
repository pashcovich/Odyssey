...
namespace Odyssey.Graphics
{
    ...
    public partial class Buffer : GraphicsResource
    {
        ...
        protected Buffer(DirectXDevice device, BufferDescription description, BufferFlags bufferFlags, PixelFormat viewFormat, IntPtr dataPointer)
            : base(device)
        {
            ...
            ElementSize = Description.SizeInBytes / ElementCount;
            Resource = new SharpDX.Direct3D11.Buffer(device, dataPointer, Description);
            Initialize();
        }
        ...
        /// <param name="bufferFlags">Type of the buffer.</param>
        /// <param name="viewFormat">The view format.</param>
        protected Buffer(DirectXDevice device, SharpDX.Direct3D11.Buffer nativeBuffer, BufferFlags bufferFlags, PixelFormat viewFormat)
            : base(device)
        {
        ...
        public Buffer ToStaging()
        {
            ...
            return new Buffer(Device, stagingDesc, BufferFlags, ViewFormat, IntPtr.Zero);
        }
            ...
            if ((Description.BindFlags & BindFlags.ShaderResource) != 0)
            {
                lock (shaderResourceViews)
                {
                    ...
                    if (!shaderResourceViews.TryGetValue(key, out srv))
                    {
                        ...
                        srv = ToDispose(new ShaderResourceView(Device, (Resource)Resource, description));
            ...
            if ((Description.BindFlags & BindFlags.RenderTarget) != 0)
            {
                lock (renderTargetViews)
                {
                    ...
                    if (!renderTargetViews.TryGetValue(renderTargetKey, out rtv))
                    {
                        ...
                        rtv = ToDispose(new RenderTargetView(Device, (Resource)Resource, description));
        ...
        /// <remarks>
        /// This method is only working when called from the main thread that is accessing the main <see cref="DirectXDevice"/>.
        ...
        public void GetData(Buffer stagingTexture, DataPointer toData)
        {
            ...
            if (toData.Size > Description.SizeInBytes)
        ...
        /// <remarks>
        /// This method is only working when called from the main thread that is accessing the main <see cref="DirectXDevice"/>. See the unmanaged documentation about Map/UnMap for usage and restrictions.
        /// </remarks>
        /// <msdn-id>ff476457</msdn-id>
        /// <unmanaged>HRESULT ID3D11DeviceContext::Map([In] ID3D11Resource* pResource,[In] unsigned int Subresource,[In] D3D11_MAP MapType,[In] D3D11_MAP_FLAG MapFlags,[Out] D3D11_MAPPED_SUBRESOURCE* pMappedResource)</unmanaged>
        /// <unmanaged-short>ID3D11DeviceContext::Map</unmanaged-short>
        ...
        {
            SetData(Device, ref fromData, offsetInBytes, options);
        }
        ...
        {
            SetData(Device, fromData, startIndex, elementCount, offsetInBytes, options);
        }
        ...
        {
            SetData(Device, fromData, offsetInBytes, options);
        }
        ...
        /// <unmanaged>HRESULT ID3D11DeviceContext::Map([In] ID3D11Resource* pResource,[In] unsigned int Subresource,[In] D3D11_MAP MapType,[In] D3D11_MAP_FLAG MapFlags,[Out] D3D11_MAPPED_SUBRESOURCE* pMappedResource)</unmanaged>
        /// <unmanaged-short>ID3D11DeviceContext::Map</unmanaged-short>
        public unsafe void SetData<TData>(DirectXDevice device, TData[] fromData, int startIndex = 0, int elementCount = 0, int offsetInBytes = 0, SetDataOptions options = SetDataOptions.Discard) where TData : struct
        {
        ...
        /// See the unmanaged documentation about Map/UnMap for usage and restrictions.
        /// </remarks>
        public unsafe void SetData(DirectXDevice device, DataPointer fromData, int offsetInBytes = 0, SetDataOptions options = SetDataOptions.Discard)
        {
            // Check size validity of data to copy to
            if ((fromData.Size + offsetInBytes) > Description.SizeInBytes)
        ...
        /// See the unmanaged documentation about Map/UnMap for usage and restrictions.
        /// </remarks>
        public unsafe void SetDynamicData(DirectXDevice device, Action<IntPtr> fromData, int offsetInBytes = 0, SetDataOptions options = SetDataOptions.Discard)
        {
            var deviceContext = (DeviceContext)device;
            try
            {
        ...
        public static Buffer New(DirectXDevice device, Buffer buffer, Format viewFormat = Format.Unknown)
        {
        ...
        /// <unmanaged>HRESULT ID3D11Device::CreateBuffer([In] const D3D11_BUFFER_DESC* pDesc,[In, Optional] const D3D11_SUBRESOURCE_DATA* pInitialData,[Out, Fast] ID3D11Buffer** ppBuffer)</unmanaged>
        /// <unmanaged-short>ID3D11Device::CreateBuffer</unmanaged-short>
        public static Buffer New(DirectXDevice device, BufferDescription description, Format viewFormat = Format.Unknown)
        {
        ...
        /// <unmanaged>HRESULT ID3D11Device::CreateBuffer([In] const D3D11_BUFFER_DESC* pDesc,[In, Optional] const D3D11_SUBRESOURCE_DATA* pInitialData,[Out, Fast] ID3D11Buffer** ppBuffer)</unmanaged>
        /// <unmanaged-short>ID3D11Device::CreateBuffer</unmanaged-short>
        public static Buffer New(DirectXDevice device, int bufferSize, BufferFlags bufferFlags, ResourceUsage usage = ResourceUsage.Default)
        {
        ...
        /// <unmanaged>HRESULT ID3D11Device::CreateBuffer([In] const D3D11_BUFFER_DESC* pDesc,[In, Optional] const D3D11_SUBRESOURCE_DATA* pInitialData,[Out, Fast] ID3D11Buffer** ppBuffer)</unmanaged>
        /// <unmanaged-short>ID3D11Device::CreateBuffer</unmanaged-short>
        public static Buffer New(DirectXDevice device, int bufferSize, BufferFlags bufferFlags, Format viewFormat, ResourceUsage usage = ResourceUsage.Default)
        {
        ...
        /// <unmanaged>HRESULT ID3D11Device::CreateBuffer([In] const D3D11_BUFFER_DESC* pDesc,[In, Optional] const D3D11_SUBRESOURCE_DATA* pInitialData,[Out, Fast] ID3D11Buffer** ppBuffer)</unmanaged>
        /// <unmanaged-short>ID3D11Device::CreateBuffer</unmanaged-short>
        public static Buffer New(DirectXDevice device, int bufferSize, int elementSize, BufferFlags bufferFlags, ResourceUsage usage = ResourceUsage.Default)
        {
        ...
        /// <unmanaged>HRESULT ID3D11Device::CreateBuffer([In] const D3D11_BUFFER_DESC* pDesc,[In, Optional] const D3D11_SUBRESOURCE_DATA* pInitialData,[Out, Fast] ID3D11Buffer** ppBuffer)</unmanaged>
        /// <unmanaged-short>ID3D11Device::CreateBuffer</unmanaged-short>
        public static Buffer New(DirectXDevice device, int bufferSize, int elementSize, BufferFlags bufferFlags, Format viewFormat, ResourceUsage usage = ResourceUsage.Default)
        {
        ...
        /// <unmanaged>HRESULT ID3D11Device::CreateBuffer([In] const D3D11_BUFFER_DESC* pDesc,[In, Optional] const D3D11_SUBRESOURCE_DATA* pInitialData,[Out, Fast] ID3D11Buffer** ppBuffer)</unmanaged>
        /// <unmanaged-short>ID3D11Device::CreateBuffer</unmanaged-short>
        public static Buffer<T> New<T>(DirectXDevice device, ref T value, BufferFlags bufferFlags, ResourceUsage usage = ResourceUsage.Default) where T : struct
        {
        ...
        /// <unmanaged>HRESULT ID3D11Device::CreateBuffer([In] const D3D11_BUFFER_DESC* pDesc,[In, Optional] const D3D11_SUBRESOURCE_DATA* pInitialData,[Out, Fast] ID3D11Buffer** ppBuffer)</unmanaged>
        /// <unmanaged-short>ID3D11Device::CreateBuffer</unmanaged-short>
        public static Buffer<T> New<T>(DirectXDevice device, T[] initialValue, BufferFlags bufferFlags, ResourceUsage usage = ResourceUsage.Default) where T : struct
        {
        ...
        /// <unmanaged>HRESULT ID3D11Device::CreateBuffer([In] const D3D11_BUFFER_DESC* pDesc,[In, Optional] const D3D11_SUBRESOURCE_DATA* pInitialData,[Out, Fast] ID3D11Buffer** ppBuffer)</unmanaged>
        /// <unmanaged-short>ID3D11Device::CreateBuffer</unmanaged-short>
        public static unsafe Buffer New(DirectXDevice device, byte[] initialValue, int elementSize, BufferFlags bufferFlags, Format viewFormat = Format.Unknown, ResourceUsage usage = ResourceUsage.Default)
        {
        ...
        /// <unmanaged>HRESULT ID3D11Device::CreateBuffer([In] const D3D11_BUFFER_DESC* pDesc,[In, Optional] const D3D11_SUBRESOURCE_DATA* pInitialData,[Out, Fast] ID3D11Buffer** ppBuffer)</unmanaged>
        /// <unmanaged-short>ID3D11Device::CreateBuffer</unmanaged-short>
        public static Buffer New(DirectXDevice device, DataPointer dataPointer, int elementSize, BufferFlags bufferFlags, ResourceUsage usage = ResourceUsage.Default)
        {
        ...
        /// <unmanaged>HRESULT ID3D11Device::CreateBuffer([In] const D3D11_BUFFER_DESC* pDesc,[In, Optional] const D3D11_SUBRESOURCE_DATA* pInitialData,[Out, Fast] ID3D11Buffer** ppBuffer)</unmanaged>
        /// <unmanaged-short>ID3D11Device::CreateBuffer</unmanaged-short>
        public static Buffer New(DirectXDevice device, DataPointer dataPointer, int elementSize, BufferFlags bufferFlags, Format viewFormat, ResourceUsage usage = ResourceUsage.Default)
        {
        ...
        private void InitCountAndViewFormat(out int count, ref PixelFormat viewFormat)
        {
            if (Description.StructureByteStride == 0)
            {
                ...
                else if (viewFormat != Format.Unknown)
                {
        ...
        private void InitializeViews()
        {
            ...
            {
                shaderResourceView = GetShaderResourceView(srvFormat, 0, ElementCount);
            }
            ...
            if ((bindFlags & BindFlags.UnorderedAccess) != 0)
            {
                ...
                unorderedAccessView = ToDispose(new UnorderedAccessView(Device, (Resource)Resource, description));
            }
        }
        ...
        public static implicit operator Resource(Buffer from)
        {
        ...
        public static implicit operator SharpDX.Direct3D11.Buffer(Buffer from)
        {
            return (SharpDX.Direct3D11.Buffer)(from == null ? null : from.Resource);
        }
        ...
        private struct ShaderResourceKey : IEquatable<ShaderResourceKey>
        {
            ...
            {
                return ViewFormat.Equals(other.ViewFormat) && Offset == other.Offset && Count == other.Count;
            }
            ...
            public override int GetHashCode()
            {
                unchecked
                {
                    int hashCode = ViewFormat.GetHashCode();
    ...
    {
        protected internal Buffer(DirectXDevice device, BufferDescription description, BufferFlags bufferFlags, PixelFormat viewFormat, IntPtr dataPointer)
            : base(device, description, bufferFlags, viewFormat, dataPointer)
        {
        }

        protected internal Buffer(DirectXDevice device, SharpDX.Direct3D11.Buffer nativeBuffer, BufferFlags bufferFlags, PixelFormat viewFormat)
        ...
        ///   <unmanaged>HRESULT ID3D11DeviceContext::Map([In] ID3D11Resource* pResource,[In] unsigned int Subresource,[In] D3D11_MAP MapType,[In] D3D11_MAP_FLAG MapFlags,[Out] D3D11_MAPPED_SUBRESOURCE* pMappedResource)</unmanaged>
        ///   <unmanaged-short>ID3D11DeviceContext::Map</unmanaged-short>
        /// <remarks>This method is only working when called from the main thread that is accessing the main <see cref="DirectXDevice" />.
        /// This method creates internally a staging resource if this texture is not already a staging resource, copies to it and map it to memory. Use method with explicit staging resource
        /// for optimal performances.</remarks>
        public T[] GetData()
        {
        ...
        /// <unmanaged>HRESULT ID3D11DeviceContext::Map([In] ID3D11Resource* pResource,[In] unsigned int Subresource,[In] D3D11_MAP MapType,[In] D3D11_MAP_FLAG MapFlags,[Out] D3D11_MAPPED_SUBRESOURCE* pMappedResource)</unmanaged>
        /// <unmanaged-short>ID3D11DeviceContext::Map</unmanaged-short>
        public void SetData(DirectXDevice device, ref T fromData, int offsetInBytes = 0, SetDataOptions options = SetDataOptions.Discard)
        {
        ...
        /// <unmanaged>HRESULT ID3D11DeviceContext::Map([In] ID3D11Resource* pResource,[In] unsigned int Subresource,[In] D3D11_MAP MapType,[In] D3D11_MAP_FLAG MapFlags,[Out] D3D11_MAPPED_SUBRESOURCE* pMappedResource)</unmanaged>
        /// <unmanaged-short>ID3D11DeviceContext::Map</unmanaged-short>
        public void SetData(DirectXDevice device, T[] fromData, int startIndex = 0, int elementCount = 0, int offsetInBytes = 0, SetDataOptions options = SetDataOptions.Discard)
        {
