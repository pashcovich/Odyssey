...
namespace Odyssey.Graphics
{
    ...
    public sealed class RenderTargetViewSelector
    {
        ...
        public TextureView this[ViewType viewType, int arrayOrDepthSlice, int mipIndex] { get { return texture.GetRenderTargetView(viewType, arrayOrDepthSlice, mipIndex); } }
    }
}
