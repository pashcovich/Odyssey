...
namespace Odyssey.Graphics
{
    ...
    public sealed class ShaderResourceViewSelector
    {
        ...
        /// <param name="mipIndex">Index of the mip.</param>
        /// <returns>An <see cref="ShaderResourceView" /></returns>
        public TextureView this[Format viewFormat, ViewType viewType, int arrayOrDepthSlice, int mipIndex] { get { return texture.GetShaderResourceView(viewFormat, viewType, arrayOrDepthSlice, mipIndex); } }
    }
}
