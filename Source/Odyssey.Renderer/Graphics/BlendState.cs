...
namespace Odyssey.Graphics
{
    ...
    {
        private readonly BlendStateDescription description;
        
        /// <summary>
        /// Gets the description of this blend state.
        /// </summary>
        public BlendStateDescription Description { get { return description; } }
        /// <summary>
        ...
        ///   <unmanaged-short>ID3D11Device::CreateBlendState</unmanaged-short>
        /// <remarks><p>An application can create up to 4096 unique blend-state objects. For each object created, the runtime checks to see if a previous object  has the same state. If such a previous object exists, the runtime will return a reference to previous instance instead of creating a duplicate object.</p></remarks>
        public static BlendState New(DirectXDevice device, BlendStateDescription description, int mask = -1)
        {
        ...
        ///   <unmanaged-short>ID3D11Device::CreateBlendState</unmanaged-short>
        /// <remarks><p>An application can create up to 4096 unique blend-state objects. For each object created, the runtime checks to see if a previous object  has the same state. If such a previous object exists, the runtime will return a reference to previous instance instead of creating a duplicate object.</p></remarks>
        public static BlendState New(DirectXDevice device, BlendStateDescription description, Color4 blendFactor,
            int mask = -1)
        {
            return new BlendState(device, description, blendFactor, mask);
        }
        ...
        public static implicit operator SharpDX.Direct3D11.BlendState(BlendState from)
        {
            return (SharpDX.Direct3D11.BlendState)(from == null ? null : from.Resource);
        }

        internal static BlendState New(DirectXDevice device, string name, BlendOption sourceBlend,
        ...
        internal static BlendStateDescription BlendDisabled
        {
            get
            {
                var description = BlendStateDescription.Default();
