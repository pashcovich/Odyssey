...
namespace Odyssey.UserInterface
{
    public abstract partial class UIElement
    {
        ...
        /// </summary>
        /// <param name="e">
        ///     The <see cref="PointerEventArgs" /> instance containing the event
        ///     data.
        /// </param>
        ...
        protected virtual void OnReadXml(XmlDeserializationEventArgs e)
        {
            ...
            Position = string.IsNullOrEmpty(sPosition) ? Vector3.Zero : TextHelper.DecodeVector3(sPosition);
        ...
        protected virtual void OnWriteXml(XmlSerializationEventArgs e)
        {
            ...
            writer.WriteAttributeString("Position", TextHelper.EncodeVector3(Position));
