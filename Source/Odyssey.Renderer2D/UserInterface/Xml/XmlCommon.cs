...
namespace Odyssey.UserInterface.Xml
{
    ...
    public abstract class XmlBaseControl
    {
        ...
        protected XmlBaseControl(Control control)
        {
            ...
            Size = new Size2F(control.Width, control.Height);
            PositionString = (control.Position != Vector2.Zero) ? XmlCommon.EncodeVector2(control.Position) : string.Empty;
            SizeString = (control.Size != default(Size2F)) ? XmlCommon.EncodeSize(control.Size) : string.Empty;

            IsEnabled = control.IsEnabled;
            IsVisible = control.IsVisible;
            TextStyleClass = control.Description.TextStyleClass;
            ControlDescriptionClass = control.Description.Name;
        }
        ...
        [XmlAttribute("NormalizedPosition")]
